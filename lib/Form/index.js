...
exports.default = exports.FromInputRender = void 0;
  ...
  if (!valueType || valueType === 'text') {
    ...
    if (valueEnum) {
      return _react.default.createElement(_select.default, Object.assign({
        ...
        ref: ref
      }, rest, item.formItemProps), (0, _util.parsingValueEnumToArray)(valueEnum).map(function (_ref2) {
...
exports.FromInputRender = FromInputRender;
  ...
  Object.keys(value).forEach(function (key) {
    ...
    if (Array.isArray(itemValue) && itemValue.length === 2 && dateFormatter) {
      if (dateFormatter === 'string') {
        ...
        tmpValue[key] = [(0, _moment.default)(itemValue[0]).format(_formatString || 'YYYY-MM-DD HH:mm:ss'), (0, _moment.default)(itemValue[1]).format(_formatString || 'YYYY-MM-DD HH:mm:ss')];
        return;
      }

      if (dateFormatter === 'number') {
        tmpValue[key] = [(0, _moment.default)(itemValue[0]).valueOf(), (0, _moment.default)(itemValue[1]).valueOf()];
      }
    }
  });
  return tmpValue;
...
var getDefaultSearch = function getDefaultSearch(search, intl, isFrom) {
  var config = {
    collapseRender: function collapseRender(collapsed) {
      if (collapsed) {
        return _react.default.createElement(_react.default.Fragment, null, intl.getMessage('tableFrom.collapsed', '展开'), _react.default.createElement(_icons.DownOutlined, {
          style: {
            marginLeft: '0.5em',
            transition: '0.3s all',
      ...
      return _react.default.createElement(_react.default.Fragment, null, intl.getMessage('tableFrom.expand', '收起'), _react.default.createElement(_icons.DownOutlined, {
        style: {
          marginLeft: '0.5em',
          transition: '0.3s all',
          transform: "rotate(".concat(collapsed ? 0 : 0.5, "turn)")
...
var FormSearch = function FormSearch(_ref3) {
  ...
  (0, _util.useDeepCompareEffect)(function () {
    ...
    counter.proColumns.forEach(function (item) {
      tempMap[(0, _util.genColumnKey)(item.key, item.dataIndex) || 'null'] = item;
    });
  ...
  var domList = columnsList.filter(function (_, index) {
    ...
    var key = (0, _util.genColumnKey)(rest.key, dataIndex);
    return _react.default.createElement(_col.default, Object.assign({}, colConfig, {
      ...
      label: rest.title,
      name: key
    }, isForm && rest), _react.default.createElement(FromInputRender, {
      item: item,
      type: type
    })));
  });
  return _react.default.createElement(_configProvider.ConfigConsumer, null, function (_ref5) {
    ...
    return _react.default.createElement("div", {
      ...
      initialValues: columnsList.reduce(function (pre, item) {
        var key = (0, _util.genColumnKey)(item.key, item.dataIndex) || '';
      ...
      gutter: 16,
      justify: "end"
    }, domList, _react.default.createElement(_col.default, Object.assign({}, colConfig, {
